...
type ToolcraftChangedDeliveryBasisFields = Readonly<{
  kind: "changed";
...
export type ToolcraftChangedDeliveryBasis =
  | ToolcraftChangedDeliveryBasisFields
  | Readonly<
      ToolcraftChangedDeliveryBasisFields & {
        completeProofReason: "dependency" | "platform";
      }
    >;
