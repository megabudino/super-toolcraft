...
7. Run lifecycle-appropriate delivery proof: prototype smoke for first product delivery, exact targeted checks for ordinary work, or one targeted iteration for a performance complaint. Full certification is a separate operator/CI command.
