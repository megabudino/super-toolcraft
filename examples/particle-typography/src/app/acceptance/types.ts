...
import type { ToolcraftCanvasSizingCoverage, ToolcraftInfinityCanvasCoverage } from "./canvas-coverage";
...
export type { ToolcraftCanvasSizingCoverage, ToolcraftInfinityCanvasCoverage } from "./canvas-coverage";
