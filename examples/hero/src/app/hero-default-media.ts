...
const portraits = [
  { dataUrl: row1Image1, fileName: "hero-row-1-image-1.jpg", row: 0 },
  { dataUrl: row1Image2, fileName: "hero-row-1-image-2.jpg", row: 0 },
  { dataUrl: row1Image3, fileName: "hero-row-1-image-3.jpg", row: 0 },
  { dataUrl: row1Image4, fileName: "hero-row-1-image-4.jpg", row: 0 },
  { dataUrl: row1Image5, fileName: "hero-row-1-image-5.jpg", row: 0 },
  { dataUrl: row1Image6, fileName: "hero-row-1-image-6.jpg", row: 0 },
  { dataUrl: row2Image1, fileName: "hero-row-2-image-1.jpg", row: 1 },
  { dataUrl: row2Image2, fileName: "hero-row-2-image-2.jpg", row: 1 },
  { dataUrl: row2Image3, fileName: "hero-row-2-image-3.jpg", row: 1 },
  { dataUrl: row2Image4, fileName: "hero-row-2-image-4.jpg", row: 1 },
  { dataUrl: row2Image5, fileName: "hero-row-2-image-5.jpg", row: 1 },
  { dataUrl: row2Image6, fileName: "hero-row-2-image-6.jpg", row: 1 },
  { dataUrl: row3Image1, fileName: "hero-row-3-image-1.jpg", row: 2 },
  { dataUrl: row3Image2, fileName: "hero-row-3-image-2.jpg", row: 2 },
  { dataUrl: row3Image3, fileName: "hero-row-3-image-3.jpg", row: 2 },
  { dataUrl: row3Image4, fileName: "hero-row-3-image-4.jpg", row: 2 },
  { dataUrl: row3Image5, fileName: "hero-row-3-image-5.jpg", row: 2 },
  { dataUrl: row3Image6, fileName: "hero-row-3-image-6.jpg", row: 2 },
  { dataUrl: row4Image1, fileName: "hero-row-4-image-1.jpg", row: 3 },
  { dataUrl: row4Image2, fileName: "hero-row-4-image-2.jpg", row: 3 },
  { dataUrl: row4Image3, fileName: "hero-row-4-image-3.jpg", row: 3 },
  { dataUrl: row4Image4, fileName: "hero-row-4-image-4.jpg", row: 3 },
  { dataUrl: row4Image5, fileName: "hero-row-4-image-5.jpg", row: 3 },
  { dataUrl: row4Image6, fileName: "hero-row-4-image-6.jpg", row: 3 },
  { dataUrl: row5Image1, fileName: "hero-row-5-image-1.jpg", row: 4 },
  { dataUrl: row5Image2, fileName: "hero-row-5-image-2.jpg", row: 4 },
  { dataUrl: row5Image3, fileName: "hero-row-5-image-3.jpg", row: 4 },
  { dataUrl: row5Image4, fileName: "hero-row-5-image-4.jpg", row: 4 },
  { dataUrl: row5Image5, fileName: "hero-row-5-image-5.jpg", row: 4 },
  { dataUrl: row5Image6, fileName: "hero-row-5-image-6.jpg", row: 4 },
  { dataUrl: row6Image1, fileName: "hero-row-6-image-1.jpg", row: 5 },
  { dataUrl: row6Image2, fileName: "hero-row-6-image-2.jpg", row: 5 },
  { dataUrl: row6Image3, fileName: "hero-row-6-image-3.jpg", row: 5 },
  { dataUrl: row6Image4, fileName: "hero-row-6-image-4.jpg", row: 5 },
  { dataUrl: row6Image5, fileName: "hero-row-6-image-5.jpg", row: 5 },
  { dataUrl: row6Image6, fileName: "hero-row-6-image-6.jpg", row: 5 },
];

export const heroDefaultMediaAssets: readonly ToolcraftDefaultMediaAssetSchema[] = [
  ...portraits.map((image, index) => ({ assetKind: "image" as const, dataUrl: image.dataUrl, fileName: image.fileName, id: `hero-default-row-${index}`, mimeType: "image/jpeg", sourceTarget: `sphere.rowImages.${image.row}` })),
  ...portraits.slice(0, 24).map((image, index) => ({ assetKind: "image" as const, dataUrl: image.dataUrl, fileName: image.fileName, id: `hero-default-gallery-${index}`, mimeType: "image/jpeg", sourceTarget: "gallery.images" })),
];
