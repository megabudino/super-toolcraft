...
export const TOOLCRAFT_RUNTIME_COMPONENT_CONTRACTS = {
  ...
  settingsTransfer: {
    aiUsageRules: [
      ...
      "When editable-output canvas sizing is enabled, the first visible Setup runtime section contains Export Settings, Import Settings, Infinity canvas, Aspect ratio, Canvas width, Canvas height, and optional Resolution scale in that order; finite sizing controls are visible only while Infinity canvas is off.",
