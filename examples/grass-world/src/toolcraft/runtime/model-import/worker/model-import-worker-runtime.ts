...
type RepairedDocumentCacheEntry = EncodedDocumentCacheEntry & Readonly<{
...
function analysisUsesLimits(
  ...
  return modelLimitNames.every((name) => analysis.limits[name] === limits[name]);
}
...
function genericFeedback(
  phase: "analyzing" | "decoding" | "repairing",
