...
export function createToolcraftModelPressureFixture(
  ...
  switch (format) {
    case "glb":
      return createGlbFixture(spec, minimumBytes);
    case "gltf":
      return createGltfFixture(spec, fileCount, minimumBytes);
    case "obj":
      return createObjFixture(spec, minimumBytes);
    case "ply":
      return createBinaryPlyFixture(spec, minimumBytes);
    case "stl":
      return createBinaryStlFixture(spec, minimumBytes);
    case "fbx":
      return createFbxFixture(spec, minimumBytes);
  }
}
