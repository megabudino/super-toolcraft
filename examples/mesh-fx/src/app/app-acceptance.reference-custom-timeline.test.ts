...
import { appAcceptance, validateToolcraftAcceptanceCoverage } from "./app-acceptance";
...
const neutralAppAcceptance = appAcceptance.map(
...
describe("starter acceptance custom reference timeline contract", () => {
  it("rejects downgrading custom reference timeline behavior to Toolcraft playback", () => {
    expect(
      validateToolcraftAcceptanceCoverage(appSchema, neutralAppAcceptance, {
