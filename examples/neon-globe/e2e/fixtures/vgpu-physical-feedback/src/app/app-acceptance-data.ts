...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser acceptance: VGPU impulse changes rendered pixels",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: finite scene at render scale 2",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser acceptance: VGPU background inclusion controls output",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser acceptance: VGPU background color reaches export",
    componentType: "color",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser acceptance: VGPU image formats remain selectable",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser acceptance: VGPU image resolutions remain selectable",
    componentType: "select",
    evidence: "product-output",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: Infinity scene bounds",
    componentType: "canvas",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: timeline reset and replay",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: viewport interaction coalesces and resumes",
  ...
  },
  {
    ...
    browser: true,
    browserTestName:
      "browser acceptance: VGPU canvas zoom coalesces and resumes",
    componentType: "canvas viewport",
    evidence: "viewport-side-effect",
    expectedObservable:
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: image export uses scene bounds",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser acceptance: VGPU export crops to Infinity scene bounds",
    componentType: "canvas",
    evidence: "exported-bytes",
    expectedObservable:
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: unsupported state rejects export",
  ...
  },
  {
    ...
    browser: true,
    browserTestName: "browser vgpu: unmount disposes owned resources",
    componentType: "switch",
    evidence: "product-output",
    expectedObservable:
