...
export const TOOLCRAFT_RUNTIME_COMPONENT_CONTRACTS = {
  ...
  performanceAcceptance: {
    aiUsageRules: [
      ...
      "Post-first-working targeted performance checks use the exact development fixture at normalized pressure 0.8 when reachable; only a path with no exact reachable development vector falls back to its maximum. First-stable and explicit performance checkpoints always use maximum fixtures.",
