...
- Before writing controls, export `appControlSectionInventory`. Each product section declares title, product entity or workflow stage, targets, and grouping reason.
