...
export const TOOLCRAFT_GLTF_ADAPTER_VERSION = "gltf-webio@1";
export const TOOLCRAFT_GLTF_GEOMETRY_DECODER_VERSION =
  "three-draco-gltf@0.185.1+meshoptimizer@1.2.0";
export const TOOLCRAFT_FBX_ADAPTER_VERSION = "fbx-three@1";
export const TOOLCRAFT_OBJ_ADAPTER_VERSION = "obj-three@1";
export const TOOLCRAFT_STL_ADAPTER_VERSION = "stl-three@1";
export const TOOLCRAFT_PLY_ADAPTER_VERSION = "ply-three@1";
...
export const TOOLCRAFT_MODEL_FILE_DROP_ACCEPT =
  TOOLCRAFT_PRODUCTION_MODEL_FORMAT_MANIFEST.map(({ accept }) => accept).join(
    ",",
  );
