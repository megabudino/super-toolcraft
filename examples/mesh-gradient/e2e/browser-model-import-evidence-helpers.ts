...
export type ToolcraftModelOutputObservation = {
  documentId: string;
...
function validateOutput(output: ToolcraftModelOutputObservation, description: string): void {
...
function validateObservation(
  ...
  if (observation.previewOutput) validateOutput(observation.previewOutput, `${description} preview`);
  if (observation.exportOutput) validateOutput(observation.exportOutput, `${description} export`);
...
async function expectTransition(
  ...
  validateObservation(expected, options);
  ...
  validateObservation(result.before, options);
  return result;
}
...
export async function expectToolcraftModelPersistenceRestore(
  ...
  validateObservation(restored, options);
