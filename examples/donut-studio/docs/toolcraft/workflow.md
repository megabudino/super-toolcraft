...
2. **Later functional-targeted delivery:** bare `npm run verify:delivery` compares current authoritative inputs with the immediately previous successful delivery and derives the exact ownership-required functional proof.
