...
import { isToolcraftRuntimeBackgroundEnabled } from "./canvas-background-state";
import {
...
import { createToolcraftCanvasModePatch } from "./canvas-frame";
...
export function getToolcraftCanvasResetPatch(
  ...
  if (resetsMode && state.canvas.mode !== "finite") {
