...
export const appAcceptance: readonly ToolcraftComponentAcceptance[] = [
  ...
  },
  {
    ...
    evidence: "media-lifecycle",
    expectedObservable:
      "First load shows the built-in icon.webp as a real Button Image preview; uploading replaces it, Remove image clears only the button image, and section reset/global Reset restore the default icon without removing the source or glass texture assets.",
