...
export const functionalTestName = "browser: focused acceptance";
export const performanceTestName = "browser perf: focused renderer path";
...
export function createDeliveryFixture(
  ...
  const rootDir = createProtectedRunnerFixture(playwrightListReport);
