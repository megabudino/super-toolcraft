...
if (
  ...
  throw new Error(
    "Toolcraft targeted performance reporting requires fixture selector, fixture resolution mode, nonce, pass ids, path ids, path, and source hash together.",
  );
}
const targetedPerformanceReport = hasAllTargetedPerformanceReportValues
  ? {
      ...
      requestAuthorityHash:
        process.env.TOOLCRAFT_PERFORMANCE_REQUEST_AUTHORITY_HASH ?? null,
