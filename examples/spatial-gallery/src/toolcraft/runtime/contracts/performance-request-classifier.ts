...
export function normalizeToolcraftPerformanceRequestText(value: string): string {
...
function isNontrivialRequestEvidence(evidence: string): boolean {
...
export function validateToolcraftPerformanceRequestEvidence(
  ...
  const normalizedEvidence = normalizeToolcraftPerformanceRequestText(evidence);
