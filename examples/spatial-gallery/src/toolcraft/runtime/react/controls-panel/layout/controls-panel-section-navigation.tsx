            ...
            {items.map((item, itemIndex) => {
              ...
              return (
                <button
                  ...
                  ref={(buttonElement) => {
                    if (buttonElement) {
                      navigationButtonRefs.current.set(item.id, buttonElement);
                    } else {
