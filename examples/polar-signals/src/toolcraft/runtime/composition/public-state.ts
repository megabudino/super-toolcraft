import { reduceDocumentToolbarPreferences } from "../modules/built-ins/external-site/toolbar-preferences";
import { reduceDocumentLocation } from "../modules/built-ins/external-site/navigation";
import {
  reduceDocumentViewportMeasurement,
  routeDocumentViewportCommand,
} from "../modules/built-ins/external-site/viewport-state";
...
const documentHandlers = {
  "document.rememberLocation": reduceDocumentLocation,
  "document.setToolbarPreferences": reduceDocumentToolbarPreferences,
  "document.invalidateViewport": reduceDocumentViewportMeasurement,
  "document.measureViewport": reduceDocumentViewportMeasurement,
  "document.setBackground": reduceDocumentViewportMeasurement,
...
export function toolcraftReducer(state: ToolcraftState, command: ToolcraftCommand): ToolcraftState {
  return routeDocumentViewportCommand(state, command, reduceBase);
}
