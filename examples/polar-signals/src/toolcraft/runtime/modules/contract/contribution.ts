...
export type ToolcraftModuleOwnershipKey =
  | "canvas-behavior:external-document"
  ...
  | "panel-surface:document-toolbar"
...
export const TOOLCRAFT_DOCUMENT_VIEWPORT_OPERATIONS = Object.freeze([
  "responsive-width",
  "content-height",
  "workspace-color",
] as const);
...
export type ToolcraftCanvasBehaviorModuleContribution =
  | Readonly<{
      ...
      operations: typeof TOOLCRAFT_DOCUMENT_VIEWPORT_OPERATIONS;
    }>
  | Readonly<{
      behavior: "editing";
...
export type ToolcraftDocumentToolbarSurfaceContribution = Readonly<{
  id: "external-site.toolbar"; kind: "panel-surface"; moduleId: "external-site";
  surface: "document-toolbar"; configuration: true;
}>;
export type ToolcraftPanelSurfaceModuleContribution =
  | ToolcraftDocumentToolbarSurfaceContribution
