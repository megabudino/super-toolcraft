...
import { createDocumentSetupSection } from "../modules/built-ins/external-site/viewport-setup";
import {
...
export function createToolcraftRuntimeSetupSection({
  ...
  if (canvas.sizing.mode === "external-document") return createDocumentSetupSection(canvas.size);
