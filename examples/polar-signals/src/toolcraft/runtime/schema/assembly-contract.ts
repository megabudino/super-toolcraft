...
export function createToolcraftAssemblyContract({
  ...
  modulePanels?: import("../modules/contributions/panel-surface-contributions").ResolvedToolcraftPanelSurfaces;
  ...
  return {
    ...
    surfaces: {
      ...
      panels: {
        ...(modulePanels?.["document-toolbar"] ? { "document-toolbar": {
          enabled: true, defaultPlacement: "bottom" as const, snapEdges: [],
          visualComponent: "DocumentToolbarPanel", requiredWrapper: "PanelHost" as const,
          dragMode: "handle" as const, capabilities: [], commands: [],
        } } : {}),
