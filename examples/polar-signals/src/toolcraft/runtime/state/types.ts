...
export type ToolcraftCommand =
  | { type: "document.setToolbarPreferences"; snapshot: unknown }
  | { type: "document.rememberLocation"; path: string }
  | import("../modules/built-ins/external-site/viewport-state").DocumentViewportCommand
  | {
...
export const toolcraftRuntimeCommandTypes = [
  ...
  "canvas.setOffset",
  "canvas.setSize",
  "document.setToolbarPreferences",
  "document.rememberLocation",
  "document.invalidateViewport",
  "document.measureViewport",
...
export type ToolcraftCanvasState = {
  documentView?: import("../modules/built-ins/external-site/viewport-preferences").DocumentViewPreferences;
...
export type ToolcraftPanelId = "controls" | "layers" | "timeline" | "toolbar" | "document-toolbar";
...
export type ToolcraftPanelsState = {
  "document-toolbar"?: ToolcraftPanelState;
...
export type ToolcraftState = {
  documentViewport?: import("../modules/built-ins/external-site/viewport-state").DocumentViewportMeasurement;
...
export type ToolcraftInitialState = {
  ...
  panels?: {
    "document-toolbar"?: Partial<ToolcraftPanelState>;
