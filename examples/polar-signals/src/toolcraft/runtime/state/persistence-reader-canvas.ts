import { readDocumentViewPreferences } from "../modules/built-ins/external-site/viewport-preferences";
...
export function readCanvas(value: unknown): Partial<ToolcraftCanvasState> | undefined {
  ...
  const documentView = readDocumentViewPreferences(value.documentView);
  if (documentView) canvas.documentView = documentView;
