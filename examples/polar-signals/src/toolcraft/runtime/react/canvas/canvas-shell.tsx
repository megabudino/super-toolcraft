...
import { ToolcraftExternalDocumentSurface } from "../external-document/document-surface";
      ...
      <CanvasViewportWorld>
        {renderEditableCanvas ? (
          <CanvasSceneSurface frame={canvasFrame}>
            {externalDocument ? <ToolcraftExternalDocumentSurface document={externalDocument} onViewportInput={handleViewportInput} /> : null}
