...
export const panelHostConfig = {
  "document-toolbar": { dragMode: "handle", panelId: "document-toolbar", snapEdges: [],
    stageClassName: "min-h-[180px]", wrapperClassName: "absolute bottom-2.5 left-1/2 z-[70] -translate-x-1/2" },
  controls: {
    dragMode: "handle",
    panelId: "controls",
