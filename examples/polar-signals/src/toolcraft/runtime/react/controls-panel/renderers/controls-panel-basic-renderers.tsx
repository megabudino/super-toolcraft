...
import { DocumentPageControl } from "../../../modules/built-ins/external-site/react/document-page-control";
...
export function renderBasicControl({
  ...
  switch (control.type) {
    ...
    case "select":
      if (control.optionsSource === "document-pages") return <DocumentPageControl key={id} name={name} />;
      return (
        <Select
          disabled={control.disabled}
          key={id}
