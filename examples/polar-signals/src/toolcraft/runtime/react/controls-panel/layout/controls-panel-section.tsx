...
import { useToolcraftSharedControlsDisabled } from "../../external-document/shared-values-context";
...
export const ControlsPanelSectionHeaderAction = React.memo(
  function ControlsPanelSectionHeaderAction({
    ...
    const sharedDisabled = useToolcraftSharedControlsDisabled(Object.values(sectionControls).map(control => control.target));
