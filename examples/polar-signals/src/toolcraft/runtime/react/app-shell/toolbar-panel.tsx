...
const selectCanUndo = (state: ToolcraftState) => state.history.authority?.canUndo ?? state.history.undo.length > 0;
const selectCanRedo = (state: ToolcraftState) => state.history.authority?.canRedo ?? state.history.redo.length > 0;
