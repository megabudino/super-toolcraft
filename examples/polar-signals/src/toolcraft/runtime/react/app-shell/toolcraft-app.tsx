...
import type { ToolcraftExternalDocumentPort } from "../../modules/built-ins/external-site/document-port";
...
import { ExternalDocumentSessionProvider } from "../external-document/document-session-context";
...
export type ToolcraftAppComposition = Readonly<{
  externalDocument?: ToolcraftExternalDocumentPort;
...
export type ToolcraftAppProps = Readonly<
  ToolcraftAppComposition & {
    /** Host-owned panels may replace controls without replacing the canvas or its store. */
    hostPanels?: { navigation?: React.ReactNode; controls?: (defaultPanel: React.ReactNode) => React.ReactNode };
    className?: string;
...
> &
  ...
  return (
    ...
    >
      ...
      {hostPanels?.navigation}
      {hostPanels?.controls ? hostPanels.controls(controlsPanel) : controlsPanel}
...
export function ToolcraftApp({
  ...
  return (
    <ToolcraftRoot
      sharedValues={externalDocument?.sharedValues}
      modelPresentation={resolvedModelPresentation}
    ...
    >
      <ToolcraftProductSceneBoundsBoundary boundsProvider={sceneBoundsProvider}>
        <ExternalDocumentSessionProvider document={externalDocument}>
        <ToolcraftAppContent
          externalDocument={externalDocument}
          {...props}
        ...
        />
        </ExternalDocumentSessionProvider>
