...
const integrationPortPresenceById = Object.freeze({
  "scene.externalDocument": (ports: ToolcraftAppPorts) => ports.scene?.externalDocument !== undefined,
...
export function createToolcraftAppPortsSnapshot(
  ...
  return Object.freeze({
    ...
    ...(scene === undefined
      ...
      : {
          scene: Object.freeze({
            ...(scene.externalDocument === undefined ? {} : {externalDocument: Object.freeze({...scene.externalDocument, targets: Object.freeze([...scene.externalDocument.targets])})}),
