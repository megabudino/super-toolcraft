          ...
          <div className="relative isolate pb-1" onMouseLeave={clearHoverPreview}>
            <div className="px-1 pt-1">
              <div className="relative h-60">
                <ScrollFade
                  className="creative-apps-kit-scrollbar h-full"
                  ...
                  watch={[filteredFonts.length, query, category, virtualStartIndex, virtualEndIndex]}
                >
                  {visibleFonts.length ? (
                      ...
                      {visibleFonts.map((font) => {
                        ...
                        return (
                          <button
                            ...
                            onMouseEnter={() => scheduleHoverPreviewIntent(font)}
                            type="button"
                          >
                            <span
