...
export type CreativeAppsKitPerformanceInteraction =
  | "animation-frame"
...
export type CreativeAppsKitPerformanceCoverage = {
  automated: boolean;
...
export type CreativeAppsKitPerformanceBudget = {
  maxExportMs?: number;
...
export type CreativeAppsKitPerformanceValueSet = {
  default: unknown;
  max?: unknown;
  min?: unknown;
};

export type CreativeAppsKitPerformanceStressFixtureKind =
  | "custom"
  | "high-density"
  | "large-canvas"
  | "large-text"
...
export type CreativeAppsKitPerformanceStressFixture = {
  kind: CreativeAppsKitPerformanceStressFixtureKind;
  minChars?: number;
  minCount?: number;
  minLines?: number;
  reason: string;
...
export type CreativeAppsKitPerformanceScenario = CreativeAppsKitPerformanceCoverage & {
  budget: CreativeAppsKitPerformanceBudget;
  controlLabel?: string;
  expectedObservable: string;
  fixture: string;
  id: string;
  interaction: CreativeAppsKitPerformanceInteraction;
  target?: string;
  stress?: boolean;
  stressFixture?: CreativeAppsKitPerformanceStressFixture;
  uiSelector?: string;
  values?: CreativeAppsKitPerformanceValueSet;
  workload: boolean;
};

export type CreativeAppsKitRendererStrategy =
  | "none"
  | "dom"
  | "svg"
  | "canvas-2d"
...
export type CreativeAppsKitRendererWorkload =
  | "none"
  | "simple-composition"
  | "text-output"
  | "vector-output"
...
export type CreativeAppsKitSourceRepresentation =
  | "reference-runtime"
  | "dom-text"
  | "svg"
  | "canvas-2d"
...
export type CreativeAppsKitProductRepresentation =
  | "text"
  | "vector"
  | "pixel"
  | "video"
...
export type CreativeAppsKitPreviewRenderer =
  | "dom"
  | "svg"
  | "canvas-2d"
  | "webgl"
...
export type CreativeAppsKitExportRenderer =
  | "none"
  | "dom"
  | "svg"
  | "canvas-2d"
...
export type CreativeAppsKitRendererLayerKind =
  | "background"
  | "product-foreground"
  | "editing-handles"
  | "export-composite";

export type CreativeAppsKitRendererLayerContent =
  | "bitmap-media"
  | "composite"
  | "dense-pattern"
  | "geometry"
...
export type CreativeAppsKitRendererLayerPrimitiveCount = "low" | "medium" | "high";

export type CreativeAppsKitRendererLayerExportMode =
  | "included"
  | "excluded"
  | "composited";

export type CreativeAppsKitRendererLayer = {
  content: readonly CreativeAppsKitRendererLayerContent[];
  exportMode: CreativeAppsKitRendererLayerExportMode;
  id: string;
  intentionalRasterizationReason?: string;
  kind: CreativeAppsKitRendererLayerKind;
  primitiveCount: CreativeAppsKitRendererLayerPrimitiveCount;
  renderer: Exclude<CreativeAppsKitRendererStrategy, "none">;
  uiSelector?: string;
};

export type CreativeAppsKitRendererTechnique = {
  exportRenderer: CreativeAppsKitExportRenderer;
  fidelityRisks: readonly string[];
  intentionalRasterizationReason?: string;
  layers?: readonly CreativeAppsKitRendererLayer[];
  performanceRisks: readonly string[];
  previewExportDifferenceReason?: string;
  previewRenderer: CreativeAppsKitPreviewRenderer;
  productRepresentation: CreativeAppsKitProductRepresentation;
  referenceRendererChangeReason?: string;
  rendererStrategy: CreativeAppsKitRendererStrategy;
  rendererWorkload: CreativeAppsKitRendererWorkload;
  sourceRepresentation: CreativeAppsKitSourceRepresentation;
  whyNotAlternativeStrategies: readonly string[];
};

export type CreativeAppsKitPerformanceConfig = {
  rendererStrategy: CreativeAppsKitRendererStrategy;
  rendererTechnique?: CreativeAppsKitRendererTechnique;
  rendererWorkload: CreativeAppsKitRendererWorkload;
  scenarios: readonly CreativeAppsKitPerformanceScenario[];
  usesCustomRenderer: boolean;
  workloadTargets: readonly string[];
};

export type CreativeAppsKitPerformanceSensitiveControl = {
  control: CreativeAppsKitControlSchema;
  controlId: string;
  target: string;
};

export type CreativeAppsKitUnclassifiedPerformanceControl = {
  control: CreativeAppsKitControlSchema;
  controlId: string;
  target: string;
};

const maxPerformanceBudgetCaps: Required<CreativeAppsKitPerformanceBudget> = {
  maxExportMs: 8000,
  maxFrameGapMs: 120,
...
export function defineCreativeAppsKitPerformance(
...
const stressFixtureKinds = new Set<CreativeAppsKitPerformanceStressFixtureKind>([
  "custom",
  "high-density",
  "large-canvas",
  "large-text",
...
function getControlSemanticText(control: CreativeAppsKitControlSchema): string {
  return [
    control.target,
...
function isSemanticallyWorkloadControl(control: CreativeAppsKitControlSchema): boolean {
...
function isPotentialWorkloadControl(control: CreativeAppsKitControlSchema): boolean {
  return control.performanceRole === "workload" || isSemanticallyWorkloadControl(control);
}

export function collectCreativeAppsKitPerformanceSensitiveControls(
  schema: ResolvedCreativeAppsKitAppSchema,
): CreativeAppsKitPerformanceSensitiveControl[] {
...
function collectCreativeAppsKitPerformanceRoleConflicts(
  schema: ResolvedCreativeAppsKitAppSchema,
): CreativeAppsKitPerformanceSensitiveControl[] {
  return (schema.panels.controls?.sections ?? []).flatMap((section) =>
    Object.entries(section.controls)
...
export function collectCreativeAppsKitUnclassifiedPerformanceControls(
  schema: ResolvedCreativeAppsKitAppSchema,
): CreativeAppsKitUnclassifiedPerformanceControl[] {
  return (schema.panels.controls?.sections ?? []).flatMap((section) =>
    Object.entries(section.controls)
      .filter(
        ([, control]) =>
...
function hasAnyBudget(budget: CreativeAppsKitPerformanceBudget): boolean {
  return Object.values(budget).some((value) => typeof value === "number" && value > 0);
}

function hasMinDefaultMax(values: CreativeAppsKitPerformanceScenario["values"]): boolean {
  return values !== undefined && "default" in values && "min" in values && "max" in values;
}

function hasStressFixtureValue(
  fixture: CreativeAppsKitPerformanceStressFixture,
): fixture is CreativeAppsKitPerformanceStressFixture & { value: unknown } {
...
function getStressFixtureErrors(
  scenario: CreativeAppsKitPerformanceScenario,
  control: CreativeAppsKitControlSchema | undefined,
): string[] {
...
function hasPositiveBudgetField(
  budget: CreativeAppsKitPerformanceBudget,
  field: keyof CreativeAppsKitPerformanceBudget,
): boolean {
...
function getBudgetCapErrors(scenario: CreativeAppsKitPerformanceScenario): string[] {
  return Object.entries(scenario.budget).flatMap(([field, value]) => {
    const budgetField = field as keyof CreativeAppsKitPerformanceBudget;
...
function requiresConcreteUiTarget(interaction: CreativeAppsKitPerformanceInteraction): boolean {
...
function getVisiblePerformanceControlTargets(schema: ResolvedCreativeAppsKitAppSchema): string[] {
...
function getActionValue(
  action: NonNullable<CreativeAppsKitControlSchema["actions"]>[number],
): string {
  return typeof action === "string" ? action : action.value;
}

function hasOutputDeliveryAction(schema: ResolvedCreativeAppsKitAppSchema): boolean {
...
function hasKeyframeTimeline(schema: ResolvedCreativeAppsKitAppSchema): boolean {
  return schema.panels.timeline?.enabled === true && schema.panels.timeline.mode === "keyframes";
}

function hasLayersPanel(schema: ResolvedCreativeAppsKitAppSchema): boolean {
...
const rasterRendererStrategies = new Set<CreativeAppsKitRendererStrategy>([
  "canvas-2d",
  "webgl",
  "webgpu",
]);

const semanticForegroundContent = new Set<CreativeAppsKitRendererLayerContent>([
  "geometry",
  "text",
]);

const detailHeavyRendererContent = new Set<CreativeAppsKitRendererLayerContent>([
  "bitmap-media",
  "dense-pattern",
  "noise",
  "shader",
...
const vectorLayerRendererStrategies = new Set<CreativeAppsKitRendererStrategy>(["dom", "svg"]);

function getLayerContentFamily(content: CreativeAppsKitRendererLayerContent): string {
...
function hasSemanticForegroundContent(layer: CreativeAppsKitRendererLayer): boolean {
  return layer.content.some((content) => semanticForegroundContent.has(content));
}

function hasDetailHeavyRendererLayer(
  technique: CreativeAppsKitRendererTechnique | undefined,
): boolean {
...
function hasZoomSensitiveRenderer(config: CreativeAppsKitPerformanceConfig): boolean {
  return (
...
function getRendererLayerErrors(technique: CreativeAppsKitRendererTechnique): string[] {
  const errors: string[] = [];
...
function getRendererTechniqueErrors(config: CreativeAppsKitPerformanceConfig): string[] {
  const errors: string[] = [];
...
export function validateCreativeAppsKitPerformanceCoverage(
  schema: ResolvedCreativeAppsKitAppSchema,
  config: CreativeAppsKitPerformanceConfig,
): string[] {
  const errors: string[] = [];
  const scenariosByTarget = new Map<string, CreativeAppsKitPerformanceScenario[]>();
  const browserTestNamesByScenario = new Map<string, string>();
  const customRendererStrategies = new Set<CreativeAppsKitRendererStrategy>([
    "dom",
    "svg",
    "canvas-2d",
    "webgl",
  ...
  const gpuRendererStrategies = new Set<CreativeAppsKitRendererStrategy>(["webgl", "webgpu"]);
  ...
  if (config.rendererWorkload === "pixel-output") {
    const hasStressPreviewOrAnimation = config.scenarios.some(
      (scenario) =>
        scenario.stress === true &&
        (scenario.interaction === "preview-render" ||
          scenario.interaction === "animation-frame"),
    );
    const hasLongTaskBudget = config.scenarios.some((scenario) =>
      hasPositiveBudgetField(scenario.budget, "maxLongTaskMs"),
    );

    if (!hasStressPreviewOrAnimation) {
      errors.push(
  ...
  const sensitiveTargets = new Set(
    collectCreativeAppsKitPerformanceSensitiveControls(schema).map((entry) => entry.target),
  );
  const performanceRoleConflicts = collectCreativeAppsKitPerformanceRoleConflicts(schema);
