  ...
  return (
    <div className={cn("pointer-events-none", config.wrapperClassName, className)} style={style}>
      <motion.div
        ...
        data-slot="creative-apps-kit-runtime-panel-host"
...
export function CreativeAppsKitPanelHost({
  onPositionChange,
  onResetPosition,
  panelType,
  position,
  ...props
}: CreativeAppsKitPanelHostProps): React.JSX.Element {
...
export function PanelStage({
  ...
  return (
    <div
      ...
      data-creative-apps-kit-panel-stage=""
    >
      {children}
    </div>
  );
