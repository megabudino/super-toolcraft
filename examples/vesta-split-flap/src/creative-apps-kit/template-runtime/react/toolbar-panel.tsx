...
import type { CreativeAppsKitPanelState } from "../state/types";
import { PanelContainer } from "./panel-host";
import type { PanelPlacement, PanelStateChange } from "./panel-host-types";
import { useCreativeAppsKitTheme } from "./theme-runtime";
...
export function ToolbarPanel({
  ...
  const { resolvedTheme, toggleResolvedTheme } = useCreativeAppsKitTheme();
  ...
  const toolbarSurface = (
    <PanelSurface
      ...
      data-effects-template-inspect-toolbar="true"
