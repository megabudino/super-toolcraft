import type { CreativeAppsKitPanelType, PanelDragMode, PanelSnapEdge } from "./panel-host-types";

type PanelTypeConfig = {
  dragMode: PanelDragMode;
  panelId: CreativeAppsKitPanelType;
...
} satisfies Record<CreativeAppsKitPanelType, PanelTypeConfig>;
