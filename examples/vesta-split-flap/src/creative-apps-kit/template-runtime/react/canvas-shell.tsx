...
import { clampCreativeAppsKitCanvasZoom } from "../state/canvas-zoom";
import type { CreativeAppsKitPoint } from "../state/types";
import { isCreativeAppsKitLayerVisibleInTree } from "./layer-tree";
...
function getNextWheelZoom(
  ...
  return clampCreativeAppsKitCanvasZoom(currentZoom + zoomDelta);
}
...
export function CanvasShell({
  ...
  const visibleMediaAssets = React.useMemo(
    () =>
      state.mediaAssets.filter((mediaAsset) =>
        isCreativeAppsKitLayerVisibleInTree(state.layers, mediaAsset.layerId),
      ),
  ...
  return (
    <div
      ...
      data-slot="creative-apps-kit-runtime-canvas"
    ...
    >
      <div
        ...
        data-creative-apps-kit-canvas-world=""
        style={{
      ...
      >
        {renderEditableCanvas ? (
          <div
            ...
            data-creative-apps-kit-canvas-content=""
            data-creative-apps-kit-editable-canvas=""
            style={{
              height: size.height,
              width: size.width,
            }}
          >
                  ...
                  return (
                    ...
                    >
                      <img
                        ...
                        data-creative-apps-kit-generated-output=""
                        draggable={false}
            ...
            {children ? (
              <div
                ...
                data-creative-apps-kit-canvas-slot=""
              >
                {children}
              </div>
            ) : null}
