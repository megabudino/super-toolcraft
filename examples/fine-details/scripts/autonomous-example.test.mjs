...
test("Reset dispatches the local runtime reset without a settings save", () => {
  const source = read("src/app/fine-details-panel-actions.ts");
...
test("preview protocol has no external website or settings-save dependency", () => {
  const source = read("src/app/fine-details-preview-protocol.ts");
